...
function remain(el) {
    ...
    animation.addEventListener("finish", () => {
        ...
        !isPlugin(pluginOrOptions) && (pluginOrOptions === null || pluginOrOptions === void 0 ? void 0 : pluginOrOptions.onEnd) ? pluginOrOptions.onEnd() : null;
    });
}
/**
...
function remove(el) {
    ...
    animation.addEventListener("finish", () => {
        ...
        (!isPlugin(optionsOrPlugin) && (optionsOrPlugin === null || optionsOrPlugin === void 0 ? void 0 : optionsOrPlugin.onEnd)) ? optionsOrPlugin.onEnd() : null;
    });
}
/**
